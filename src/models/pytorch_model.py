# code heavily inspired by https://pytorch.org/tutorials/intermediate/char_rnn_classification_tutorial.html
import pandas as pd
import torch
...
if __name__ == "__main__":
    load_dotenv()
    dataset = NamesDataset(data_dir=os.getenv("PATH_TO_BEERADVOCATE_BEERS"), brewery_dir=os.getenv("PATH_TO_BEERADVOCATE_BREWERIES"))
    train_set, test_set = torch.utils.data.random_split(dataset, [.85, .15], generator = torch.Generator().manual_seed(2024))
    n_hidden = 128
